  ...
  <div class="collapse navbar-collapse" id="navbarText">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active x" >
        <a class="nav-link a" style="color: #E7E7E8; font-size: 17px;" href="employee.php?council=<?php if($x !=''){echo $x; }?>">
Home <span class="sr-only">(current)</span></a>
       ...
       <li class="nav-item x">
        <a class="nav-link a" style="color: #E7E7E8; font-size: 17px;" href="showdec.php">Show Decisions</a>
      </li>



       <li class="nav-item x">
        <a class="nav-link a" style="color: #E7E7E8; font-size: 17px;" href="vote.php">Vote Decisions</a>
      </li>


    
     <li class="nav-item x">
        <a class="nav-link a" style="color: #E7E7E8; font-size: 17px;" href="docpost.php">Posts</a>
      </li>
    </ul>

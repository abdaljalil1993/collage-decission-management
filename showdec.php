...
<div class="col-md-4 well mr-3" style="border-radius:10px;background-color:#efefef;border:1px solid #ccc">
...
<a href="decinfo.php?id='.$row['id'].'" class="btn btn-primary btn-lg">Read More</a>
<hr>
</div>

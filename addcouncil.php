...
<div class="container" >
  <div class="row">
    ...
    <h1 class="text-warning">Add New Council</h1> 
    <hr>
   <form action="addcouncil.php" method="post" >
 ...
 <label>Collage  : </label>
  <select class="form-control" name="c">
    <?php
    include'conn.php';
    $r=mysqli_query($con,"select * from col");
...
$r=mysqli_query($con,"insert into council(name,col)
  values('$name','$c')");

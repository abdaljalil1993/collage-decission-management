...
<div class="container" >
  <div class="row">
   ...
   <h1 class="text-warning">All Collage</h1> 
    <hr>
...
$con=mysqli_connect("localhost","bacttrai_WPERM","fadidebow@1993","bacttrai_WPERM")or die("error db".mysqli_error($con));
    ...
    */
    $t=mysqli_query($con,"select * from col");
...
<td><a href="mcol.php?id='.$row['id'].'" class="btn btn-danger">Delete</a></td>
  ...
  if(isset($_GET['id']))
    {
      ...
      $t=mysqli_query($con,"delete from col where id='$x'");
      if(isset($t)){
        echo '<script type="text/javascript">toastr.success("delete collage Successfully");</script>';

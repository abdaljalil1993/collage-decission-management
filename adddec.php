...
<div class="container" >
  <div class="row">
    ...
    <h1 class="text-warning">Add Decision</h1> 
    <hr>
   <form action="adddec.php" method="post" >
      <textarea type="text" placeholder="subject" class="form-control" name="sub"></textarea> <br>

   <textarea type="text" placeholder="Dependent on it" class="form-control" name="dep"></textarea> <br>

      <textarea type="text" placeholder="After Take Alook" class="form-control" name="look"></textarea> <br>


         <textarea type="text" placeholder="After Deliberation" class="form-control" name="del"></textarea> <br>
...
$council=isset($_POST['council'])?$_POST['council']:'';
...
$r=mysqli_query($con,"insert into decision(subject,depend,takelook,delibration,username,dt,conc)
  values('$sub','$dep','$look','del','$user','$dt','".$_SESSION['sec']."')");

...
<div class="col-md-8 well" style="border-radius:10px;background-color:#efefef;border:1px solid #ccc;text-align:right">

<h1>'.$row['subject'].' عنوان القرار  المطروح </h1>
<hr>

<h3>'.$row['depend'].' اعتمادا على  مايلي </h3>
<hr>
<h3>'.$row['takelook'].' وبأخذ النظر  بما يلي </h3>
<hr>
<h3>'.$row['delibration'].' نوصي ب التالي </h3>

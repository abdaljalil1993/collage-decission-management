...
<div class="container" >
  <div class="row">
    ...
    <h1 class="text-warning">Create Doctor Account</h1> 
    <hr>
 ...
 <input type="email" placeholder="email" class="form-control" name="ph"> <br>
  ...
  <select class="form-control" name="council">
    <?php
    include'conn.php';
    $r=mysqli_query($con,"select * from council");
...
$r=mysqli_query($con,"insert into users1(name,email,password,type,section)
  values('$name','$phone','$des','doctor','$council')");
